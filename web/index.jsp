  ...
  <div class="section">
    ...
    <!--   Icon Section   -->
      ...
      <div class="col s12 m4 center">
          ...
          <div class="row">
          <p class="light">    <p>Le concept de voyage le plus simple au monde. Plus de X propriétés dans plus de X pays. <br/>
          Il s'agit d'un échange mutuel : vous restez chez moi, je reste chez vous; en même temps. <br />
          Des Vacances inoubliables, vivez intensément votre séjour !! </p>
        </p>
        </div>
      </div>
  ...
  <div class="section">
   ...
   <div class="col s12 m4 center">
	       ...
	       <div class="row">
		        ...
		        Continuez à vivre des vacances incroyables et faîtes nous part de vos souvenirs !</p>
	      </div>
    </div>
